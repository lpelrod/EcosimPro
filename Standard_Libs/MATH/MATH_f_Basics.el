...
--------------------------------------------------------------------------------
-- Purpose:
--    To calculate the maximum value of a real array
--------------------------------------------------------------------------------
FUNCTION REAL maxND(IN REAL x[])
DECLS
...
--------------------------------------------------------------------------------
-- Purpose:
--    To calculate the minimum value of a real array
--------------------------------------------------------------------------------
FUNCTION REAL minND(IN REAL x[])
DECLS
   INTEGER N   "Number of elements in the array"
   REAL min
BODY
...
--------------------------------------------------------------------------------
-- Purpose:
--    To calculate the maximum value of an integer array
--------------------------------------------------------------------------------
FUNCTION REAL maxND_int(IN INTEGER x[])
DECLS
   INTEGER N   "Number of elements in the array"
   INTEGER max
BODY
...
--------------------------------------------------------------------------------
-- Purpose:
--    To calculate the minimum value of an integer array
--------------------------------------------------------------------------------
FUNCTION REAL minND_int(IN INTEGER x[])
DECLS
   INTEGER N   "Number of elements in the array"
   INTEGER min
BODY
...
--------------------------------------------------------------------------------
-- Purpose:
--    Function to calculate the sum of all elements in a real array. Also valid
--    for arrays sized with enumerative variables.
--------------------------------------------------------------------------------
FUNCTION REAL sumND
   (
   IN REAL A[]                  "Array of elements (-)"
   )
...
--------------------------------------------------------------------------------
-- Purpose:
--    Function to calculate the sum of all elements in an integer array. Also 
--    valid for arrays sized with enumerative variables.
--------------------------------------------------------------------------------
FUNCTION INTEGER sumND_int
   (
   IN INTEGER A[]                "Array of elements (-)"
   )
